    ...
    <body>
        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                ...
                <a class="navbar-brand" href="/">Control CREE</a>
            </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-3 col-md-2 sidebar" >
                    ...
                    <li class="active"><a href="#">Programación<span class="sr-only">(current)</span></a></li>
                    <li><a href=" {{ route('asignacionhorario') }} ">Asignacion de horarios</a></li>
